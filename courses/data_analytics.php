...
<head>
    ...
    <title>Data Analytics & BI | Abid Khan Hub</title>
    ...
    <style>
        ...
        /* HERO SECTION */
        .hero-banner {
            background: linear-gradient(45deg, rgba(5, 7, 10, 1) 30%, rgba(0, 210, 255, 0.1)), 
...
<section class="hero-banner text-center">
    <div class="container">
        <span class="badge bg-info mb-3 px-4 py-2 rounded-pill fw-bold text-dark">BUSINESS INTELLIGENCE</span>
        <h1 class="display-3 master-heading mb-3">DATA <span class="text-gradient">ANALYTICS</span></h1>
        <p class="lead text-secondary mx-auto mb-5 fw-bold" style="max-width: 850px; font-size: 1.4rem;">
            Transform raw data into strategic decisions. Master SQL, Power BI, and Advanced Statistical Modeling to become a high-impact Data Analyst.
        </p>
    </div>
</section>
...
<div class="container py-5">
    <div class="row g-5">
        <div class="col-lg-8">
            <h3 class="fw-800 mb-4"><i class="fas fa-chart-pie me-2 text-info"></i> Curriculum & Mastery</h3>
            <div class="glass-table-container">
                <table class="table align-middle">
                    ...
                    <tbody>
                        <tr>
                            <td><span class="module-tag">Data Foundations</span></td>
                            <td>SQL Querying, Database Schema Design, Data Cleaning, ETL Processes</td>
                        </tr>
                        <tr>
                            <td><span class="module-tag">Statistical Analysis</span></td>
                            <td>Descriptive & Inferential Statistics, Hypothesis Testing, Regression Analysis</td>
                        </tr>
                        <tr>
                            <td><span class="module-tag">BI Visualization</span></td>
                            <td>Microsoft Power BI, Tableau Desktop, DAX Formulas, Interactive Dashboards</td>
                        </tr>
                        <tr>
                            <td><span class="module-tag">Technical Stack</span></td>
                            <td>Advanced Excel for Analytics, Python (Pandas & Matplotlib), Google Looker Studio</td>
                        </tr>
                        <tr>
                            <td><span class="module-tag">Executive Reporting</span></td>
                            <td>Storytelling with Data, KPI Development, Stakeholder Presentation, Forecasting</td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="glass-table-container">
                ...
                <div class="mb-4">
                    ...
                    <h4 class="fw-800 text-white">PKR 26,000 / Per Month</h4>
                    <p class="small text-secondary fw-bold">(Total Package: PKR 36,000)</p>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <p class="text-white fw-bold"><i class="fas fa-certificate me-2 text-warning"></i> Certified Data Analytics Specialist</p>
                </div>

                <hr style="border-color: rgba(0, 210, 255, 0.2); border-width: 2px;">

                <a href="../signup.php?course=data_analytics_pro" class="btn btn-enroll w-100 mt-2">
