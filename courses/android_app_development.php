...
<head>
    ...
    <title>Android App Development | Abid Khan Hub</title>
    ...
    <style>
        ...
        .hero-banner {
            background: linear-gradient(45deg, rgba(5, 7, 10, 1) 30%, rgba(79, 195, 247, 0.1)), 
                        url('https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?auto=format&fit=crop&w=1350&q=80');
        ...
        .text-gradient {
            background: linear-gradient(to right, #4fc3f7, #00ff88);
...
<section class="hero-banner text-center">
    <div class="container">
        <span class="badge bg-success mb-3 px-4 py-2 rounded-pill fw-bold">MOBILE ENGINEERING</span>
        <h1 class="display-3 master-heading mb-3">ANDROID <span class="text-gradient">APP DEVELOPMENT</span></h1>
        <p class="lead text-secondary mx-auto mb-5 fw-bold" style="max-width: 850px; font-size: 1.4rem;">
            Build industry-grade mobile applications. Master Kotlin, Android Studio, and Advanced API integrations under the Professor's elite mentorship.
        </p>
    </div>
</section>
...
<div class="container py-5">
    <div class="row g-5">
        <div class="col-lg-8">
            <h3 class="fw-800 mb-4"><i class="fas fa-mobile-screen-button me-2 text-info"></i> Syllabus & Tech Stack</h3>
            <div class="glass-table-container">
                <table class="table align-middle">
                    ...
                    <tbody>
                        <tr>
                            <td><span class="module-tag">Language Core</span></td>
                            <td>Kotlin Programming, Java Fundamentals, Data Types, Null Safety, Coroutines</td>
                        </tr>
                        <tr>
                            <td><span class="module-tag">UI/UX Design</span></td>
                            <td>XML Layouts, Material Design 3, View Binding, ConstraintLayout, Custom Views</td>
                        </tr>
                        <tr>
                            <td><span class="module-tag">Architecture</span></td>
                            <td>MVVM Pattern, Room Database, LiveData, ViewModel, Navigation Component</td>
                        </tr>
                        <tr>
                            <td><span class="module-tag">Cloud & Data</span></td>
                            <td>Firebase (Auth, Firestore, Messaging), Retrofit API, JSON Parsing, Glide</td>
                        </tr>
                        <tr>
                            <td><span class="module-tag">Play Store Ready</span></td>
                            <td>App Signing, ProGuard, Play Console Management, Versioning, AdMob Integration</td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="col-lg-4">
            <h3 class="fw-800 mb-4"><i class="fas fa-microchip me-2 text-info"></i> Course Portal</h3>
            <div class="glass-table-container">
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <h4 class="fw-800 text-white">PKR 60,000 / Per Month</h4>
                    <p class="small text-secondary fw-bold">(Total Package: PKR 32,000)</p>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="p-3 rounded-4 bg-dark border border-secondary">
                        <p class="text-white mb-1 fw-bold">Thu - Fri - Sat</p>
                ...
                <div class="mb-4">
                    ...
                    <p class="text-white fw-bold"><i class="fas fa-certificate me-2 text-warning"></i> Certified Android Developer</p>
                </div>

                <hr style="border-color: rgba(79, 195, 247, 0.2); border-width: 2px;">

                <a href="../signup.php?course=android_dev_pro" class="btn btn-enroll w-100 mt-2">
                    <i class="fas fa-rocket me-2"></i> INITIALIZE BUILD
                </a>
                
                <p class="text-center mt-3 small text-secondary fw-bold">Exclusive Intake: Only 10 Developers per Batch</p>
            </div>
        </div>
    </div>
</div>
