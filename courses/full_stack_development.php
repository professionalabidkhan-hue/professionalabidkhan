...
<head>
    ...
    <title>Full Stack Development | Abid Khan Hub</title>
    ...
    <style>
        ...
        /* HERO SECTION */
        .hero-banner {
            background: linear-gradient(45deg, rgba(2, 6, 23, 1) 30%, rgba(139, 92, 246, 0.1)), 
        ...
        .glass-table-container:hover { border-color: var(--primary-violet); }
...
<section class="hero-banner text-center">
    <div class="container">
        <span class="badge bg-primary mb-3 px-4 py-2 rounded-pill fw-bold">ENGINEERING EXCELLENCE</span>
        <h1 class="display-3 master-heading mb-3">FULL STACK <span class="text-gradient">DEVELOPMENT</span></h1>
        <p class="lead text-secondary mx-auto mb-5 fw-bold" style="max-width: 850px; font-size: 1.4rem;">
            Build production-ready digital products. Master the Art of Frontend, Backend, and Database Architecture using the industry's most powerful tech stacks.
        </p>
    </div>
</section>
...
<div class="container py-5">
    <div class="row g-5">
        <div class="col-lg-8">
            <h3 class="fw-800 mb-4"><i class="fas fa-layer-group me-2 text-info"></i> Development Roadmap</h3>
                ...
                <table class="table align-middle">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>React.js, Next.js (App Router), Tailwind CSS, Framer Motion, TypeScript</td>
                        </tr>
                        <tr>
                            <td><span class="module-tag">Backend Logic</span></td>
                            <td>Node.js, Express.js, RESTful APIs, JWT Authentication, WebSockets</td>
                        </tr>
                        <tr>
                            <td><span class="module-tag">Database Arch</span></td>
                            <td>MongoDB (NoSQL), PostgreSQL (SQL), Prisma ORM, Redis Caching</td>
                        </tr>
                        <tr>
                            <td><span class="module-tag">State & Logic</span></td>
                            <td>Redux Toolkit, TanStack Query (React Query), Context API, Zod Validation</td>
                        </tr>
                        <tr>
                            <td><span class="module-tag">DevOps & Deploy</span></td>
                            <td>Docker Basics, Vercel/AWS Deployment, CI/CD, Git Flow Mastery</td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="col-lg-4">
            <h3 class="fw-800 mb-4"><i class="fas fa-code-branch me-2 text-info"></i> Admission Portal</h3>
            <div class="glass-table-container">
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <p class="small text-secondary fw-bold">(Total Package: PKR 180,000)</p>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <p class="text-white fw-bold"><i class="fas fa-certificate me-2 text-warning"></i> Certified Senior Full-Stack Engineer</p>
                </div>

                <hr style="border-color: rgba(139, 92, 246, 0.2); border-width: 2px;">

                <a href="../signup.php?course=fullstack_pro" class="btn btn-enroll w-100 mt-2">
                    <i class="fas fa-rocket me-2"></i> START BUILDING
                </a>
                
                <p class="text-center mt-3 small text-secondary fw-bold">Capacity: 15 Engineers per Batch</p>
            </div>
        </div>
    </div>
</div>
