...
<head>
    ...
    <title>UI/UX Design | Abid Khan Hub</title>
    ...
    <style>
        :root {
            --design-pink: #fb7185; 
            --design-gold: #fbbf24;
            --glass-bg: rgba(18, 18, 22, 0.9);
            --border-glow: rgba(251, 113, 133, 0.3);
        }
        body {
        ...
        .master-avatar-nav {
            ...
            box-shadow: 0 0 15px var(--design-pink);
            object-fit: cover;
        }
        /* HERO SECTION */
        .hero-banner {
            background: linear-gradient(45deg, rgba(15, 15, 18, 1) 30%, rgba(251, 113, 133, 0.1)), 
                        url('https://images.unsplash.com/photo-1586717791821-3f44a563eb4c?auto=format&fit=crop&w=1350&q=80');
        ...
        .glass-table-container:hover { border-color: var(--design-pink); }
        .table { color: #fff !important; font-size: 1.1rem; }
        .table thead th { 
            border-bottom: 3px solid var(--design-pink); 
...
<section class="hero-banner text-center">
    <div class="container">
        <span class="badge bg-danger mb-3 px-4 py-2 rounded-pill fw-bold">HUMAN-CENTERED DESIGN</span>
        <h1 class="display-3 master-heading mb-3">UI/UX <span class="text-gradient">DESIGN</span></h1>
        <p class="lead text-secondary mx-auto mb-5 fw-bold" style="max-width: 850px; font-size: 1.4rem;">
            Design experiences, not just screens. Master the psychology of users, the art of Figma, and the science of scalable design systems.
        </p>
    </div>
</section>
...
<div class="container py-5">
    <div class="row g-5">
        <div class="col-lg-8">
            <h3 class="fw-800 mb-4"><i class="fas fa-pen-nib me-2 text-info"></i> Creative Roadmap</h3>
            <div class="glass-table-container">
                <table class="table align-middle">
                    <thead>
                        <tr>
                            <th style="width: 30%;">Phase</th>
                            <th>Competencies & Toolkit</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td><span class="module-tag">UX Research</span></td>
                            <td>User Personas, Empathy Mapping, Information Architecture, User Flows</td>
                        </tr>
                        <tr>
                            <td><span class="module-tag">Visual UI</span></td>
                            <td>Typography, Color Theory, Grid Systems, Figma Mastery, Auto-Layout</td>
                        </tr>
                        <tr>
                            <td><span class="module-tag">Prototyping</span></td>
                            <td>Micro-interactions, Smart Animate, High-Fidelity Flows, Usability Testing</td>
                        </tr>
                        <tr>
                            <td><span class="module-tag">Design Systems</span></td>
                            <td>Atomic Design, Component Libraries, Handoff Documentation, Tokens</td>
                        </tr>
                        <tr>
                            <td><span class="module-tag">Product Strategy</span></td>
                            <td>MVP Frameworks, Business Logic in Design, Stakeholder Management</td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="col-lg-4">
            <h3 class="fw-800 mb-4"><i class="fas fa-palette me-2 text-info"></i> Design Studio</h3>
            <div class="glass-table-container">
                <div class="mb-4">
                    <label class="small text-info fw-900 d-block mb-1">PROGRAM DURATION</label>
                    <h4 class="fw-800 text-white">16 Weeks (4 Months)</h4>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="p-3 rounded-4 bg-dark border border-secondary">
                        <p class="text-white mb-1 fw-bold">Sat - Sun (Creative Batch)</p>
                        <p class="text-info mb-0 fw-bold"><i class="far fa-clock"></i> 2:00 PM - 5:00 PM</p>
                    </div>
                </div>

                <div class="mb-4">
                    <label class="small text-info fw-900 d-block mb-1">CERTIFICATION</label>
                    <p class="text-white fw-bold"><i class="fas fa-medal me-2 text-warning"></i> Professional Product Designer</p>
                </div>

                <hr style="border-color: rgba(251, 113, 133, 0.2); border-width: 2px;">

                <a href="../signup.php?course=uiux_pro" class="btn btn-enroll w-100 mt-2">
                    <i class="fas fa-bezier-curve me-2"></i> JOIN THE STUDIO
                </a>
                
                <p class="text-center mt-3 small text-secondary fw-bold">Strictly 12 Designers per Cohort</p>
            </div>
        </div>
    </div>
</div>
