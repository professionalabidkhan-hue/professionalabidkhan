...
<head>
    ...
    <title>Full-Stack Web Engineering | Abid Khan Hub</title>
...
<section class="hero-banner text-center">
    <div class="container">
        <span class="badge bg-success mb-3 px-4 py-2 rounded-pill fw-bold">SYSTEMS ENGINEERING</span>
        <h1 class="display-3 master-heading mb-3">WEB DEVELOPMENT <span class="text-gradient">FULL-STACK</span></h1>
        <p class="lead text-secondary mx-auto mb-5 fw-bold" style="max-width: 850px; font-size: 1.4rem;">
            Engineer high-performance web applications. From Frontend architecture to Backend logic and Database security under the Professor's direct mentorship.
        </p>
    </div>
</section>
...
<div class="container py-5">
    <div class="row g-5">
        <div class="col-lg-8">
            <h3 class="fw-800 mb-4"><i class="fas fa-code me-2 text-info"></i> Syllabus & Stack</h3>
            <div class="glass-table-container">
                <table class="table align-middle">
                    ...
                    <tbody>
                        <tr>
                            <td><span class="module-tag">Frontend Mastery</span></td>
                            <td>HTML5, CSS3 (Sass), JavaScript (ES6+), Bootstrap 5, Component Architecture</td>
                        </tr>
                        <tr>
                            <td><span class="module-tag">Dynamic Logic</span></td>
                            <td>React.js or Vue.js, State Management, API Integration, Performance Optimization</td>
                        </tr>
                        <tr>
                            <td><span class="module-tag">Backend Engine</span></td>
                            <td>PHP / Node.js, Server-Side Logic, Authentication Systems, Security Protocols</td>
                        </tr>
                        <tr>
                            <td><span class="module-tag">Data Architecture</span></td>
                            <td>MySQL / MongoDB, Database Design, SQL Optimization, CRUD Operations</td>
                        </tr>
                        <tr>
                            <td><span class="module-tag">DevOps & Deployment</span></td>
                            <td>Git/GitHub, Domain/Hosting Management, SSL Installation, SEO Best Practices</td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="col-lg-4">
            <h3 class="fw-800 mb-4"><i class="fas fa-server me-2 text-info"></i> Course Portal</h3>
            <div class="glass-table-container">
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <div class="p-3 rounded-4 bg-dark border border-secondary">
                        <p class="text-white mb-1 fw-bold">Mon - Tue - Wed</p>
                ...
                <div class="mb-4">
                    ...
                    <p class="text-white fw-bold"><i class="fas fa-certificate me-2 text-warning"></i> Professional Web Engineer Cert.</p>
                </div>

                <hr style="border-color: rgba(79, 195, 247, 0.2); border-width: 2px;">

                <a href="../signup.php?course=web_development_pro" class="btn btn-enroll w-100 mt-2">
                    <i class="fas fa-shield-halved me-2"></i> ACCESS DEV VAULT
                </a>
                
                <p class="text-center mt-3 small text-secondary fw-bold">Exclusive Intake: Only 10 Engineers per Batch</p>
            </div>
        </div>
    </div>
</div>
